...
$8\times$ more parameter-efficient on compositional tasks, with the
hierarchical variant statistically superior on image-like inputs
($50$ seeds, $p<0.0001$). These results suggest that hybrid system
