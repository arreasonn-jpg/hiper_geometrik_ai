...
Düz Kronecker yalnızca $1/20$ tohumda kazanıyor. Darboğaz
...
(göreve bağlı) eğitilir, konfigürasyon başına 20 tohum.
...
korelasyonu: $r = +0.953$, $p = 0.012$ (n=5). \textbf{H2
doğrulandı.}
...
Kronecker graf yapılı bir görevde $\%21$ kaybediyor. Avantaj
...
Yine de Düz Kronecker yalnızca $1/20$ tohumda kazanıyor. Bu,
...
bu $18/20$ kazanma oranını açıklar. Bu, grid gereksinimiyle
tutarlıdır.
